...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    istaknuto: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBookImageBookImage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image_file: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    image_type: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::book-image.book-image'
    > &
      Schema.Attribute.Private;
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    book_image: Schema.Attribute.Relation<
      'manyToOne',
      'api::book-image.book-image'
    >;
    ...
    external_id: Schema.Attribute.BigInteger &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    ourPublication: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDigitalizationDigitalization
  extends Struct.CollectionTypeSchema {
  collectionName: 'digitalizations';
  info: {
    displayName: 'Digitalization';
    pluralName: 'digitalizations';
    singularName: 'digitalization';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    digitalizacijska_oznaka: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    fizicka_oznaka: Schema.Attribute.BigInteger &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::digitalization.digitalization'
    >;
    napomena: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    operater: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    uredjaj: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    vlasnik: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiKnjigeKnjige extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    godina: Schema.Attribute.Integer;
    invbroj: Schema.Attribute.Integer;
    isbn: Schema.Attribute.String;
    knjigaId: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::knjige.knjige'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    razina: Schema.Attribute.String;
    signatura: Schema.Attribute.String;
    skupina1: Schema.Attribute.String;
    skupina1a: Schema.Attribute.String;
    skupina2: Schema.Attribute.String;
    skupina4: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zbirka: Schema.Attribute.String;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::book-image.book-image': ApiBookImageBookImage;
      'api::book.book': ApiBookBook;
      'api::category.category': ApiCategoryCategory;
      'api::digitalization.digitalization': ApiDigitalizationDigitalization;
